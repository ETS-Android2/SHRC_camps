...
import static edu.aku.hassannaqvi.shrc_camps.core.MainApp.sharedPref;
import static edu.aku.hassannaqvi.shrc_camps.database.CreateTable.DATABASE_COPY;
import static edu.aku.hassannaqvi.shrc_camps.database.CreateTable.DATABASE_NAME;
...
import edu.aku.hassannaqvi.shrc_camps.core.AppInfo;
import edu.aku.hassannaqvi.shrc_camps.core.MainApp;
import edu.aku.hassannaqvi.shrc_camps.database.DatabaseHelper;
import edu.aku.hassannaqvi.shrc_camps.databinding.ActivityLoginBinding;
...
*//*
    ...
    public void onSyncDataClick(View view) {
        ...
        if (networkInfo != null && networkInfo.isConnected()) {
            startActivity(new Intent(this, edu.aku.hassannaqvi.shrc_camps.ui.SyncActivity.class).putExtra("login", true));
        } else {
